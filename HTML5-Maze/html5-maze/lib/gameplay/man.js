...
function drawMan()
{
    var gameCanvas = document.getElementById("maze_element");
    ...
    var manWidth = tileWidth*0.5;
    var manHeight = tileHeight*0.5;
    ...
    ctx.fillRect(manDrawX + (tileWidth * 0.25), //x
                 manDrawY + (tileHeight * 0.25), //y
                 manWidth, manHeight);
}
